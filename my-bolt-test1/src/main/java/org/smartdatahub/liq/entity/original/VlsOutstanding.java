 ...
 */
@Entity
@Table(name = "VLS_OUTSTANDING")
public class VlsOutstanding
    implements LiqOutstanding,
        Identifiable<String>,
        Serializable,
        EqualsSimpleFieldSupport<VlsOutstanding> {
  ...
  @JoinColumn(name = "OST_CID_BORROWER", insertable = false, updatable = false)
  private /*3*/ VlsCustomer liqCustomerBorrower;

  @ManyToOne(fetch = FetchType.LAZY)
  @JoinColumn(name = "OST_PID_DEAL", insertable = false, updatable = false)
  private /*3*/ VlsDeal liqDeal;

  @ManyToOne(fetch = FetchType.LAZY)
  @JoinColumn(name = "OST_PID_FACILITY", insertable = false, updatable = false)
  ...
  @OneToMany(mappedBy = "liqOutstanding", fetch = FetchType.LAZY, targetEntity = VlsOstTran.class)
  ...
  public boolean equals(Object obj) {
    ...
    VlsOutstanding other = (VlsOutstanding) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(VlsOutstanding other) {
