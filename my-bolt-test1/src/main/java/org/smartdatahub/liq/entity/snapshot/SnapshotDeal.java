 ...
 */
@Entity
@Table(name = "SNAP_DEAL")
public class SnapshotDeal
    implements LiqDeal, Identifiable<String>, Serializable, EqualsSimpleFieldSupport<SnapshotDeal> {
  ...
  @OneToOne(
      ...
      cascade = {CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REMOVE})
  private /*3*/ SnapshotDealAdmin liqDealAdmin;
  ...
  /** The deal administrator table. Management of money transfer between lenders and borrowers. */
  public void setLiqDealAdmin(SnapshotDealAdmin liqDealAdmin) {
  ...
  public boolean equals(Object obj) {
    ...
    SnapshotDeal other = (SnapshotDeal) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(SnapshotDeal other) {
