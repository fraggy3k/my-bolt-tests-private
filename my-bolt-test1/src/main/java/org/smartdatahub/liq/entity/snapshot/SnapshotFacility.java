 ...
 */
@Entity
@Table(name = "SNAP_FACILITY")
public class SnapshotFacility
    implements LiqFacility,
        Identifiable<String>,
        Serializable,
        EqualsSimpleFieldSupport<SnapshotFacility> {
  ...
  @ManyToOne(
      fetch = FetchType.LAZY,
      cascade = {CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REMOVE})
  @JoinColumn(name = "S_BRANCH")
  private /*3*/ SnapshotBranch liqBranch;
  ...
  @ManyToOne(
      fetch = FetchType.LAZY,
      cascade = {CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REMOVE})
  @JoinColumn(name = "S_FACILITY_TYPE")
  private /*3*/ SnapshotFacilityType liqFacilityType;

  @OneToOne(
      mappedBy = "liqFacility",
      fetch = FetchType.LAZY,
      targetEntity = SnapshotFacilityAdmin.class,
      cascade = {CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REMOVE})
  private /*3*/ SnapshotFacilityAdmin liqFacilityAdmin;
  ...
  @OneToMany(
      mappedBy = "liqFacility",
      fetch = FetchType.LAZY,
      targetEntity = SnapshotFacHostAgr.class,
      cascade = {CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REMOVE})
  ...
  /** The branch table. */
  public void setLiqBranch(SnapshotBranch liqBranch) {
   ...
   * - facility type.
   */
  public void setLiqFacilityType(SnapshotFacilityType liqFacilityType) {
   ...
   * facilities and their loans.
   */
  public void setLiqFacilityAdmin(SnapshotFacilityAdmin liqFacilityAdmin) {
   ...
   * The facility host bank agregation. Finstra version was almost empty -> filled by best knowledge
   */
  public void addLiqFacHostAgrs(List<SnapshotFacHostAgr> liqFacHostAgrs) {
  ...
  public boolean equals(Object obj) {
    ...
    SnapshotFacility other = (SnapshotFacility) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(SnapshotFacility other) {
