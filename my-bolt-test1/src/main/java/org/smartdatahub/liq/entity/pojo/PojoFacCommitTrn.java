 ...
 */
public class PojoFacCommitTrn
    implements LiqFacCommitTrn,
        Identifiable<String>,
        Serializable,
        EqualsSimpleFieldSupport<PojoFacCommitTrn> {
  ...
  private /*3*/ PojoOstTran liqOstTran;
  ...
  /** The outstanding transaction table. Transactions directly related to outstandings. */
  public void setLiqOstTran(PojoOstTran liqOstTran) {
    this.liqOstTran = liqOstTran;
  }

  /** The outstanding transaction table. Transactions directly related to outstandings. */
  public void addLiqOstTransCommitTrn(List<PojoOstTran> liqOstTransCommitTrn) {
  ...
  public boolean equals(Object obj) {
    ...
    PojoFacCommitTrn other = (PojoFacCommitTrn) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(PojoFacCommitTrn other) {
