 ...
 */
public class PojoFacBorrDetl
    implements LiqFacBorrDetl,
        Identifiable<String>,
        Serializable,
        EqualsSimpleFieldSupport<PojoFacBorrDetl> {
  ...
  private /*3*/ PojoDealBorrower liqDealBorrower;
  ...
  /** The deal borrower table. The borrowers that are associated with a deal. */
  public void setLiqDealBorrower(PojoDealBorrower liqDealBorrower) {
  ...
  public boolean equals(Object obj) {
    ...
    PojoFacBorrDetl other = (PojoFacBorrDetl) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(PojoFacBorrDetl other) {
