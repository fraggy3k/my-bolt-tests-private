 ...
 */
public class PojoOutstanding
    implements LiqOutstanding,
        Identifiable<String>,
        Serializable,
        EqualsSimpleFieldSupport<PojoOutstanding> {
  ...
  private /*3*/ PojoCustomer liqCustomerBorrower;
   ...
   * lending business with the bank is considered a customer.
   */
  public void setLiqCustomerBorrower(PojoCustomer liqCustomerBorrower) {
  ...
  /** The outstanding transaction table. Transactions directly related to outstandings. */
  public void addLiqOriginalOstTrans(List<PojoOstTran> liqOriginalOstTrans) {
  ...
  /** The outstanding transaction table. Transactions directly related to outstandings. */
  public void addLiqOstTrans(List<PojoOstTran> liqOstTrans) {
  ...
  public boolean equals(Object obj) {
    ...
    PojoOutstanding other = (PojoOutstanding) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(PojoOutstanding other) {
