...
public class PojoFamGlobal2
    implements Identifiable<IdClassFamGlobal2>,
        Serializable,
        EqualsSimpleFieldSupport<PojoFamGlobal2> {
  ...
  public boolean equals(Object obj) {
    ...
    PojoFamGlobal2 other = (PojoFamGlobal2) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(PojoFamGlobal2 other) {
