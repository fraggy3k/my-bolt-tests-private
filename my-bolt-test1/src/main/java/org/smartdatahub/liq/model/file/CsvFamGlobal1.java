...
/**
 * SELECT GB1_CDE_CODE, GB1_TID_TABLE_ID, GB1_DSC_CODE, GB1_IND_ACTIVE, GB1_IND_MAY_DEACT,
 * GB1_TSP_REC_CREATE, GB1_TSP_REC_UPDATE, GB1_UID_REC_CREATE, GB1_UID_REC_UPDATE, FROM blablabla
 *
 * @author Julian Egyptien (smartdatahub.org)
 */
public class CsvFamGlobal1
    implements Identifiable<IdClassFamGlobal1>,
        Serializable,
        EqualsSimpleFieldSupport<CsvFamGlobal1> {
  ...
  public boolean equals(Object obj) {
    ...
    CsvFamGlobal1 other = (CsvFamGlobal1) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(CsvFamGlobal1 other) {
