...
/**
 * SELECT FHA_PID_DEAL, FHA_PID_FACILITY, FHA_AMT_CLOSING, FHA_AMT_DC_CLOSE, FHA_AMT_DC_GROSS,
 * FHA_AMT_DC_GRS_ADJ, FHA_AMT_DC_NET, FHA_AMT_DC_NET_ADJ, FHA_AMT_DC_PRECLOS, FHA_AMT_GROSS,
 * FHA_AMT_GROSS_ADJ, FHA_AMT_NET, FHA_AMT_NET_ADJ, FHA_AMT_PRECLOSE, FHA_TSP_REC_CREATE,
 * FHA_TSP_REC_UPDATE, FHA_UID_REC_CREATE, FHA_UID_REC_UPDATE, FROM blablabla
 *
 * @author Julian Egyptien (smartdatahub.org)
 */
public class CsvFacHostAgr
    implements Identifiable<IdClassFacHostAgr>,
        Serializable,
        EqualsSimpleFieldSupport<CsvFacHostAgr> {
  ...
  public boolean equals(Object obj) {
    ...
    CsvFacHostAgr other = (CsvFacHostAgr) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(CsvFacHostAgr other) {
