...
/**
 * SELECT OST_RID_OUTSTANDNG, OST_AMT_BANK_GROSS, OST_AMT_BANK_NET, OST_AMT_CURRENT,
 * OST_AMT_FC_BNK_GRS, OST_AMT_FC_BNK_NET, OST_AMT_FC_CURRENT, OST_AMT_NACR_TLRNC, OST_AMT_ORIGINAL,
 * OST_AMT_SCHED_BAL, OST_CDE_ACR_PERIOD, OST_CDE_ACT_ACR_RL, OST_CDE_ANVDTE_EOM, OST_CDE_CURRENCY,
 * OST_CDE_DEC_PRECN, OST_CDE_DEC_ROUND, OST_CDE_ENDTE_RULE, OST_CDE_EXTENSION, OST_CDE_FRAC_IRATE,
 * OST_CDE_FRAC_ROUND, OST_CDE_FRG_WTHHLD, OST_CDE_GL_CLASS, OST_CDE_LOAN_PURP, OST_CDE_OB_ST_CTG,
 * OST_CDE_OBJ_STATE, OST_CDE_OUTSTD_TYP, OST_CDE_OVERAGE_RL, OST_CDE_PERF_STAT, OST_CDE_PRICE_OPT,
 * OST_CDE_RAC_REPRIC, OST_CDE_RAP_MTHD, OST_CDE_REPR_FREQ, OST_CDE_RISK_TYPE, OST_CDE_RQST_CCY,
 * OST_CDE_SIC, OST_CDE_SIC_CNTRY, OST_CDE_TAX_EXEMPT, OST_CDE_TRSRY_AREA, OST_CID_BORROWER,
 * OST_DTE_ACT_REPRIC, OST_DTE_ANIVERSARY, OST_DTE_EFFECTIVE, OST_DTE_EXPIRY_CLC,
 * OST_DTE_EXPIRY_ENT, OST_DTE_EXPIRY_FNL, OST_DTE_PAID_DOWN, OST_DTE_RAC_REPRIC, OST_DTE_REPRICING,
 * OST_IND_AC_CF_ONLY, OST_IND_AC_SCD_BAL, OST_IND_ACCRUABLE, OST_IND_ANV_DTE_AP,
 * OST_IND_AUTO_EXTND, OST_IND_AUTO_PREPF, OST_IND_BILL_BORR, OST_IND_BILL_MATR, OST_IND_DONT_MAIL,
 * OST_IND_DONT_PRNT, OST_IND_FACING_FEE, OST_IND_FLOAT_RATE, OST_IND_HAS_RPR_DT,
 * OST_IND_INC_XMLBIL, OST_IND_INT_DUE_RP, OST_IND_ISSUIN_FEE, OST_IND_MATCH_FUND,
 * OST_IND_NOTF_RCVD, OST_IND_PMAT_INT, OST_IND_REINSTATBL, OST_IND_SEPACRFEES, OST_IND_SYNC_PC_RP,
 * OST_NME_ALIAS, OST_NUM_BILL_DAYS, OST_NUM_EXT_INCR, OST_NUM_NOTIFICATN, OST_PCT_FRG_WTHHLD,
 * OST_PCT_NACR_TLRNC, OST_PCT_TAX_EXEMPT, OST_PID_DEAL, OST_PID_FACILITY, OST_PID_SUBLIMIT,
 * OST_RID_COLLAT_DEF, OST_RID_LCHG_RULE, OST_RTE_FC_HS_RATE, OST_RTE_FC_RATE, OST_TSP_REC_CREATE,
 * OST_TSP_REC_UPDATE, OST_UID_REC_CREATE, OST_UID_REC_UPDATE, FROM blablabla
 *
 * @author Julian Egyptien (smartdatahub.org)
 */
public class CsvOutstanding
    implements Identifiable<String>, Serializable, EqualsSimpleFieldSupport<CsvOutstanding> {

  private static final long serialVersionUID = 1L;
  public static final String TABLE_ID = "OST";

  @Id private /*4*/ String ridOutstandng;
  ...
  public boolean equals(Object obj) {
    ...
    CsvOutstanding other = (CsvOutstanding) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(CsvOutstanding other) {
