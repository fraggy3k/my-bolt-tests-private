...
/**
 * SELECT OTR_RID_OST_TRAN, OTR_AMT_ACTUAL, OTR_AMT_FUND_FROZN, OTR_AMT_NEW_RELSE, OTR_AMT_PREMIUM,
 * OTR_AMT_REQUESTED, OTR_AMT_SCHED_BAL, OTR_CDE_ACCR_FREQ, OTR_CDE_GROUP_TYPE, OTR_CDE_LOAN_PURP,
 * OTR_CDE_OB_ST_CTG, OTR_CDE_OBJ_STATE, OTR_CDE_PROC_AREA, OTR_CDE_REPR_FREQ, OTR_CDE_RISK_TYPE,
 * OTR_CDE_TRNS_PURP, OTR_CDE_TYPE, OTR_DTE_EFFECTIVE, OTR_DTE_RELEASE, OTR_DTE_REPRICING,
 * OTR_IND_AUTO_RDUCE, OTR_IND_AUTO_RELSE, OTR_IND_CREATE_TRN, OTR_IND_NON_ACCR, OTR_IND_PMT_FR_BOR,
 * OTR_PID_SUBLIMIT, OTR_RID_COMMIT_TRN, OTR_RID_GROUP_TRAN, OTR_RID_LINK_TRN, OTR_RID_ORIG_OST,
 * OTR_RID_OUTSTANDNG, OTR_TSP_REC_CREATE, OTR_TSP_REC_UPDATE, OTR_UID_PROCESSOR,
 * OTR_UID_REC_CREATE, OTR_UID_REC_UPDATE, FROM blablabla
 *
 * @author Julian Egyptien (smartdatahub.org)
 */
public class CsvOstTran
    implements Identifiable<String>, Serializable, EqualsSimpleFieldSupport<CsvOstTran> {
  ...
  public boolean equals(Object obj) {
    ...
    CsvOstTran other = (CsvOstTran) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(CsvOstTran other) {
