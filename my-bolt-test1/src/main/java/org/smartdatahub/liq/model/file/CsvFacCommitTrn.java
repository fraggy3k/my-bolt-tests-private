...
/**
 * SELECT FTR_RID_COMMIT_TRN, FTR_AMT_COMMITMENT, FTR_AMT_UNAVAIL, FTR_CDE_CIRC_STATE,
 * FTR_CDE_CONTRA_ST, FTR_CDE_INV_TYPE, FTR_CDE_LINK_TYPE, FTR_CDE_OB_ST_CTG, FTR_CDE_OBJ_STATE,
 * FTR_CDE_RSK_BK_BYR, FTR_CDE_RSK_BK_SLR, FTR_CDE_TRANS_TYPE, FTR_CDE_TYPE, FTR_DTE_CIRC_CLOSE,
 * FTR_DTE_EFFECTIVE, FTR_DTE_RELEASE, FTR_FID_FAC_INV_ID, FTR_IID_INV_ID, FTR_IND_AFF_TRD_LN,
 * FTR_IND_AUTO_RELSE, FTR_IND_MARKETING, FTR_IND_MKTG_LINK, FTR_PCT_PRICE, FTR_PCT_SKIM_INT,
 * FTR_PID_DEAL, FTR_PID_FACILITY, FTR_RID_FROM, FTR_RID_GROUP_TRN, FTR_RID_LINK, FTR_RID_POOL,
 * FTR_RID_TO, FTR_TSP_REC_CREATE, FTR_TSP_REC_UPDATE, FTR_TXT_AMEND_NUM, FTR_UID_PROCESSOR,
 * FTR_UID_REC_CREATE, FTR_UID_REC_UPDATE, FROM blablabla
 *
 * @author Julian Egyptien (smartdatahub.org)
 */
public class CsvFacCommitTrn
    implements Identifiable<String>, Serializable, EqualsSimpleFieldSupport<CsvFacCommitTrn> {

  private static final long serialVersionUID = 1L;
  public static final String TABLE_ID = "FTR";

  @Id private /*4*/ String ridCommitTrn;
  ...
  public boolean equals(Object obj) {
    ...
    CsvFacCommitTrn other = (CsvFacCommitTrn) obj;
  ...
  @Override
  public CompareHelper equalsSimpleFields(CsvFacCommitTrn other) {
