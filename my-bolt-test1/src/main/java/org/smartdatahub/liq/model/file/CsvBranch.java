...
/**
 * SELECT BRN_CDE_BRANCH, BRN_CDE_BANK, BRN_CDE_COUNTRY, BRN_CDE_FUNCT_CCY, BRN_CDE_GL,
 * BRN_CDE_LOCAL_CCY, BRN_CDE_TME_REGION, BRN_CID_CUST_ID, BRN_DSC_BRANCH, BRN_IND_ACTIVE,
 * BRN_IND_CENTRAL_SC, BRN_IND_MFCOF_ACCT, BRN_IND_NET_BORR, BRN_IND_NET_CASHFL, BRN_NUM_FISC_MM,
 * BRN_TSP_REC_CREATE, BRN_TSP_REC_UPDATE, BRN_UID_REC_CREATE, BRN_UID_REC_UPDATE, FROM blablabla
 *
 * @author Julian Egyptien (smartdatahub.org)
 */
public class CsvBranch
    implements Identifiable<String>, Serializable, EqualsSimpleFieldSupport<CsvBranch> {
  ...
  @Override
  public CompareHelper equalsSimpleFields(CsvBranch other) {
