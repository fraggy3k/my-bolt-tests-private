...
/**
 * SELECT DEA_PID_DEAL, DEA_AMT_GLO_PRECLO, DEA_AMT_NACR_TLRNC, DEA_CDE_BANK, DEA_CDE_BRANCH,
 * DEA_CDE_CR_ASN, DEA_CDE_CR_PARTIC, DEA_CDE_DEAL_CLASS, DEA_CDE_DEAL_STAT, DEA_CDE_DEP_SUBTYP,
 * DEA_CDE_DEPT, DEA_CDE_EXPENSE, DEA_CDE_INPAL_RULE, DEA_CDE_ORIG_CCY, DEA_CDE_PDLGC_RULE,
 * DEA_CDE_PERFORMING, DEA_CDE_PROC_AREA, DEA_CDE_REASON_NFS, DEA_CDE_SELL_STAGE,
 * DEA_CDE_TERM_REASN, DEA_DTE_AGREEMENT, DEA_DTE_APPROVED, DEA_DTE_CANCEL_EFF, DEA_DTE_COMMIT_LTR,
 * DEA_DTE_DEAL_CLSD, DEA_DTE_FAC_CUTOFF, DEA_DTE_LAST_REVWD, DEA_DTE_PROJ_CLOSE, DEA_DTE_SBLC_EXP,
 * DEA_DTE_SBLC_ISSUE, DEA_DTE_TERM_EFF, DEA_IND_ACCT_ENABL, DEA_IND_ACTIVE, DEA_IND_ACTUAL,
 * DEA_IND_AUTO_GEN, DEA_IND_AUTO_NONP, DEA_IND_AUTO_PREPF, DEA_IND_AUTO_REL, DEA_IND_CNSL_BILL,
 * DEA_IND_CRA, DEA_IND_CUSIP_LST, DEA_IND_DONT_MAIL, DEA_IND_DONT_PRNT, DEA_IND_EARLY_DISC,
 * DEA_IND_FUND, DEA_IND_GUAR_DEAL, DEA_IND_HLT, DEA_IND_INC_XMLBIL, DEA_IND_NATNL_CRDT,
 * DEA_IND_OUTSD_DEAL, DEA_IND_PAST_DUEB, DEA_IND_RESTRICT, DEA_IND_RSRV_ADJ, DEA_IND_SOLE_LENDR,
 * DEA_NME_ALIAS_NAME, DEA_NME_DEAL, DEA_NUM_DEAL_CNTL, DEA_NUM_EURO_INTRM, DEA_NUM_GRACE_PER,
 * DEA_NUM_MATCH_DRAW, DEA_NUM_MAX_DRAW, DEA_PCT_NACR_TLRNC, DEA_RID_COLLAT_DEF, DEA_RTO_FCT_SALDIF,
 * DEA_TSP_REC_CREATE, DEA_TSP_REC_UPDATE, DEA_TXT_CUSIP_NUM, DEA_TXT_ISIN_NUM, DEA_UID_ADMNSTRATR,
 * DEA_UID_LAST_REVWR, DEA_UID_ORIGINATOR, DEA_UID_REC_CREATE, DEA_UID_REC_UPDATE,
 * DEA_UID_REL_MANAGR, DEA_XID_ALT_DEALID, DEA_XID_ANSI_ID, DEA_XID_NATNL_CRDT, FROM blablabla
 *
 * @author Julian Egyptien (smartdatahub.org)
 */
public class CsvDeal
    implements Identifiable<String>, Serializable, EqualsSimpleFieldSupport<CsvDeal> {
  ...
  @Override
  public CompareHelper equalsSimpleFields(CsvDeal other) {
